...
public class Tabuleiro {
	...
	public void evoluirPeao(Dimension d, String type, int lado, TabuleiroFrame frame) {

        String nome;
        nome = type;
        this.GetPosicaoPorDimension(d).RemoverPeca();
		CriarPeca(nome, d, lado);

		TabuleiroFrame.GetInstance().desgrifarQuadradoPeloTabuleiro(d.width, d.height, this.posicoes);
	}
	...
	private void TerminarJogo (int jogadorPerdedor) {
		...
		jFrame.add(jLabel);
		jLabel.setText("Jogador "+ jogadorVencedor + " venceu!");
